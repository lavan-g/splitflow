...
export function GroupCardActions({
  ...
  return (
    <div className="relative">
      ...
      >
        <summary className="flex list-none cursor-pointer items-center rounded-lg border border-white/20 bg-white/5 p-1.5 text-slate-100 transition hover:bg-white/10">
      ...
      {feedback ? (
        <div className="pointer-events-none absolute right-0 top-10 z-20 w-56 [animation:fadeOut_3s_ease_forwards]">
